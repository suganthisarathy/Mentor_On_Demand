...
%>
	...
	<div class="content">
      ...
      <li><a href="requestlist">Request Details</a></li>
      <li><a href="mentorlogincheck">Logout</a>
    </ul>
			</div>
		</nav>
		<div class="container">
			<h3 style="text-align: center;">List of Request</h3>
			<br>
			<section class="row">
			 <table>
	...
	%>
           ...
           <tr>
				...
				<td><p class="col-md-2 ptext">
					<a href="acceptRequest?userid=<%= e.getUserId() %>&mentorid=<%= m.getMentorId()%>"><input type="submit" value="accept"></a>
				</p></td>
				<td><p class="col-md-2 ptext">
					<a href="rejectRequest?userid=<%= e.getUserId() %>&mentorid=<%= m.getMentorId()%>"><input type="submit" value="reject"></a>
				</p></td>
